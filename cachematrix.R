...
## If the inverse of x has already been solved, then it will retrieve the inverse from the cache.
## If the inverse of x has not been calculated, then it will solve the inverse and return solution.
